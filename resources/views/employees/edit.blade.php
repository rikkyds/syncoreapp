                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    @if($employee->ktp_photo)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($employee->ktp_photo) }}" alt="KTP Photo" class="w-32">
                                        </div>
                                    @endif
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    @if($employee->bpjs_health_photo)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($employee->bpjs_health_photo) }}" alt="BPJS Health Card Photo" class="w-32">
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    @if($employee->npwp_photo)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($employee->npwp_photo) }}" alt="NPWP Photo" class="w-32">
                                        </div>
                                    @endif
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="employment_status" name="employment_status" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                        ...
                                        <option value="intern" {{ $employee->employment_status == 'intern' ? 'selected' : '' }}>Intern</option>
                                    </select>
