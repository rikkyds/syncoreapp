        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('employee-shifts.update', $employeeShift) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="employee_name" id="employee_name" 
                                           value="{{ old('employee_name', $employeeShift->employee_name) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           readonly>
                                    @error('employee_name')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="nip_nik" id="nip_nik" 
                                           value="{{ old('nip_nik', $employeeShift->nip_nik) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           readonly>
                                    @error('nip_nik')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="shift_date" id="shift_date" 
                                           value="{{ old('shift_date', $employeeShift->shift_date->format('Y-m-d')) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           required>
                                    @error('shift_date')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="shift_name" id="shift_name" 
                                        ...
                                        @foreach($shiftNames as $key => $value)
                                            <option value="{{ $key }}" 
                                                {{ (old('shift_name', $employeeShift->shift_name) == $key) ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="time" name="start_time" id="start_time" 
                                           value="{{ old('start_time', $employeeShift->formatted_start_time) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           required>
                                    @error('start_time')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="time" name="end_time" id="end_time" 
                                           value="{{ old('end_time', $employeeShift->formatted_end_time) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           required>
                                    @error('end_time')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    ...
                                    <select name="work_location" id="work_location" 
                                        ...
                                        @foreach($workLocations as $location)
                                            <option value="{{ $location->name }}" 
                                                {{ (old('work_location', $employeeShift->work_location) == $location->name) ? 'selected' : '' }}>
                                                {{ $location->name }}
                                            </option>
                                        @endforeach
                                        <!-- Add current value if not in list -->
                                        @if(!$workLocations->pluck('name')->contains($employeeShift->work_location))
                                            <option value="{{ $employeeShift->work_location }}" selected>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="attendance_status" id="attendance_status" 
                                        ...
                                        @foreach($attendanceStatuses as $key => $value)
                                            <option value="{{ $key }}" 
                                                {{ (old('attendance_status', $employeeShift->attendance_status) == $key) ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="work_day_type" id="work_day_type" 
                                        ...
                                        @foreach($workDayTypes as $key => $value)
                                            <option value="{{ $key }}" 
                                                {{ (old('work_day_type', $employeeShift->work_day_type) == $key) ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="supervisor_name" id="supervisor_name" 
                                           value="{{ old('supervisor_name', $employeeShift->supervisor_name) }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                           required>
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <textarea name="shift_notes" id="shift_notes" rows="4" 
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                          placeholder="Catatan tambahan, pergantian shift, atau instruksi khusus...">{{ old('shift_notes', $employeeShift->shift_notes) }}</textarea>
                                @error('shift_notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('employee-shifts.show', $employeeShift) }}" 
