            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['total_users'] }} total users</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Kelola pengguna sistem dan role mereka</p>
                    <a href="{{ route('users.index') }}" class="inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                        Kelola Users
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Manajemen Karyawan</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['total_employees'] }} karyawan</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Kelola data karyawan dan informasi mereka</p>
                    <a href="{{ route('employees.index') }}" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300">
                        Kelola Karyawan
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Manajemen Role</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Konfigurasi role sistem</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Atur role dan permission sistem</p>
                    <a href="{{ route('roles.index') }}" class="inline-flex items-center text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-green-300">
                        Kelola Roles
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Manajemen Perusahaan</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['total_companies'] }} perusahaan</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Kelola data perusahaan dan cabang</p>
                    <a href="{{ route('companies.index') }}" class="inline-flex items-center text-purple-600 dark:text-purple-400 hover:text-purple-900 dark:hover:text-purple-300">
                        Kelola Perusahaan
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        <div class="bg-orange-100 dark:bg-orange-900 p-3 rounded-full mr-4">
                            <svg class="w-6 h-6 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Manajemen Proyek</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['total_projects'] }} proyek</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Kelola proyek dan progress mereka</p>
                    <a href="{{ route('projects.index') }}" class="inline-flex items-center text-orange-600 dark:text-orange-400 hover:text-orange-900 dark:hover:text-orange-300">
                        Kelola Proyek
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Manajemen Cuti</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $stats['pending_leaves'] }} pending</p>
                        </div>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Kelola pengajuan cuti karyawan</p>
                    <a href="{{ route('employee-leaves.index') }}" class="inline-flex items-center text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300">
                        Kelola Cuti
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
